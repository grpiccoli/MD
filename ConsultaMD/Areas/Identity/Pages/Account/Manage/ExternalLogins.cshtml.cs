...
namespace ConsultaMD.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            CurrentLogins.Clear();
            ((List<UserLoginInfo>)CurrentLogins).AddRange(await _userManager.GetLoginsAsync(user).ConfigureAwait(false));
            ((List<AuthenticationScheme>)OtherLogins).AddRange((await _signInManager.GetExternalAuthenticationSchemesAsync().ConfigureAwait(false))
