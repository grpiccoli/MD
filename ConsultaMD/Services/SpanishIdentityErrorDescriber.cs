...
namespace ConsultaMD.Services
{
    public class SpanishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"El RUT '{userName}' ya está registrado, por favor ingrese un RUT diferente o inicie sesión." }; }
